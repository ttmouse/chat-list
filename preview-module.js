...
class PreviewModule {
  constructor(chatListWidget) {
    ...
    this.groups = chatListWidget.groups;
    this.scripts = chatListWidget.scripts;
  ...
  createPreviewLayer() {
    ...
    const previewHTML = `
      <div class="preview-layer" id="scriptPreviewLayer">
        ...
        <div class="preview-actions">
          <button class="btn btn-edit-preview">编辑</button>
        </div>
      </div>
    `;
    ...
    this.previewLayer = document.getElementById('scriptPreviewLayer');
